...
#    EVAL_FILES="${DATA_DIR}/nq_data/train.jsonl ${DATA_DIR}/nq_data/nq_dev.jsonl ${DATA_DIR}/nq_data/nq_test.jsonl"
...
#    EVAL_FILES="${DATA_DIR}/nq_data/nq_test.jsonl"
    ...
    EXPERIMENT_NAME="${size}_t5_model_lm_${FINETUNED}_retrieve_lca_multiple_document_generation"
    PRECISION="fp32" # "bf16"
