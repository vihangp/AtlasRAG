...
do 
    ...
    RETRIEVE_DIR='/data/projects/monet/atlas/experiments/base_t5_model_lm_TRUE_generate_lca'
...
#    EVAL_FILES="${RETRIEVE_DIR}/nq_dev-step-0.jsonl ${RETRIEVE_DIR}/train-step-0.jsonl ${RETRIEVE_DIR}/trivia_train-step-0.jsonl"
    ...
    EVAL_FILES="${RETRIEVE_DIR}/nq_dev-step-0-step-0-eval.jsonl" 
    FINETUNED="TRUE"
